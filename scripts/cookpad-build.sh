...
#   Xcode 15.4
#   NDK r27c at $ANDROID_SDK_ROOT/ndk/27.2.12479018
#   JDK 17
...
if [[ ! -d "$ANDROID_NDK_ROOT" ]]; then
  echo "[error] NDK r27c not found at $ANDROID_NDK_ROOT"
  echo "Install it with: sdkmanager 'ndk;27.2.12479018'"
  exit 1
fi

echo "[build] Building Android full-gpl (NDK r27c) ..."
...
echo "[build] Building iOS full-gpl (Xcode $(xcodebuild -version | head -1)) ..."
